...
const PMIDS = ["28549705", "36332759", "28630217", "26016893"];

const POST = {
  slug: "dead-hang-shoulder-grip-strength",
  title:
    "데드행(매달리기), 어깨·악력에 진짜 효과 있을까? — 직접 RCT 한계와 인접 데이터로 본 가치",
  excerpt:
    "데드행 직접 RCT는 적지만, 악력은 300만 명 데이터에서 사망률을 강하게 예측하고 어깨 운동은 통증·기능 개선이 분명해요. 안전하게 시작하는 법과 주의할 분들을 정리했습니다.",
  body_md: readFileSync(
    new URL("../content/dead-hang-shoulder-grip-strength.md", import.meta.url),
    "utf8"
  ),
  tags: ["데드행", "매달리기", "악력", "어깨 건강", "철봉", "자세"],
  status: "draft",
  category: "fitness",
  evidence_level: "meta",
};
