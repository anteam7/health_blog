// 크레아틴 글 본문 + 메타를 health_contents 에 insert.
// 사용법:  node scripts/seed-content-creatine.mjs
...
const PMIDS = ["39519498", "39074168", "39070254", "28615996"];

const POST = {
  slug: "creatine-general-population",
  title: "크레아틴 보충제, 일반인에게도 효과 있을까? — 메타분석으로 본 근력·체구성·인지 기능 효과",
  excerpt:
    "크레아틴은 운동선수만의 보충제가 아니에요. 23개 연구 메타분석에서 일반 성인의 근력·근비대·인지 기능 향상이 확인됐고, 5년 장기 안전성도 검증됐습니다. 하루 5g, 어떻게 먹어야 효과적인지 정리했어요.",
  body_md: readFileSync(
    new URL("../content/creatine-general-population.md", import.meta.url),
    "utf8"
  ),
  tags: ["크레아틴", "보충제", "근력", "근비대", "인지 기능", "운동 보충제"],
  status: "draft",
  category: "fitness",
  evidence_level: "meta",
};
