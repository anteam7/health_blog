...
const PMIDS = ["36502286", "30704301", "40419564", "35711313"];

const POST = {
  slug: "exercise-time-morning-vs-evening",
  title:
    "운동 시간대, 아침 vs 저녁 — 체지방·근력·혈압 outcome별 차이 정리",
  excerpt:
    "체중 감량과 근비대는 시간대 차이가 없지만, 체지방률·혈압·수면 같은 세부 outcome은 시간대에 따라 약간 달라요. 11~100명 RCT와 메타분석 데이터로 본인 시간대 결정 가이드를 정리했어요.",
  body_md: readFileSync(
    new URL("../content/exercise-time-morning-vs-evening.md", import.meta.url),
    "utf8"
  ),
  tags: ["운동 시간대", "아침 운동", "저녁 운동", "체지방", "혈압", "수면"],
  status: "draft",
  category: "fitness",
  evidence_level: "rct",
};
...
await sb.from("health_admin_actions").insert({
  actor_email: ACTOR,
  action: "seed_content_exercise_time",
