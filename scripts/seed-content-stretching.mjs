// 운동 전/후 스트레칭 글 본문 + 메타를 health_contents 에 insert.
// 사용법:  node scripts/seed-content-stretching.mjs
...
const PMIDS = ["37644585", "39614059", "34025459", "38595642"];

const POST = {
  slug: "stretching-before-vs-after-workout",
  title:
    "운동 전 vs 운동 후 스트레칭, 어느 쪽이 더 중요할까? — 메타분석으로 본 진짜 효과",
  excerpt:
    "운동 전 정적 스트레칭은 폭발력을 떨어뜨리고, 운동 후 스트레칭은 근육통 회복에 큰 도움이 안 된다는 게 최근 메타분석 결론이에요. 정적 스트레칭의 진짜 자리와 동적 워밍업 7~10분이 왜 권장되는지 정리했습니다.",
  body_md: readFileSync(
    new URL("../content/stretching-before-vs-after-workout.md", import.meta.url),
    "utf8"
  ),
  tags: ["스트레칭", "워밍업", "동적 스트레칭", "정적 스트레칭", "운동 전", "운동 후"],
  status: "draft",
  category: "fitness",
  evidence_level: "meta",
};
...
await sb.from("health_admin_actions").insert({
  actor_email: ACTOR,
  action: "seed_content_stretching",
